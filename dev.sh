...
tmux new-session php artisan octane:start \; split-window -h "docker compose up" \; split-window -h "sleep 5 && php artisan horizon" \; split-window -h "pnpm dev" \; split-window -v "while :; do php artisan schedule:run; sleep 1; done" \; attach
