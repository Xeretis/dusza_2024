...
class TeamExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('programmingLanguage.name')->label(
                'Programozási nyelv'
            ),
            ...
            ExportColumn::make('competitor1.name')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ->where('type', CompetitorProfileType::Student)
                        ->sortBy('id')
                        ->values()
                        ->get(0, (object) ['name' => 'NEM LÉTEZIK'])->name;
                }),
            ...
            ExportColumn::make('competitor1.grade')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(0, (object) ['grade' => 'NEM LÉTEZIK'])->grade;
                }),
            ...
            ExportColumn::make('competitor1.email')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(0, (object) ['email' => 'NEM LÉTEZIK'])->email ??
                        'NINCS MEGADVA';
                }),
            ...
            ExportColumn::make('competitor1.username')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->get(
                            0,
                            (object) ['user' => ['username' => 'NEM LÉTEZIK']]
                        )->user?->username ?? 'NEM LÉTEZIK A FELHASZNÁLÓ';
                }),
            ...
            ExportColumn::make('competitor2.name')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(1, (object) ['name' => 'NEM LÉTEZIK'])->name;
                }),
            ...
            ExportColumn::make('competitor2.grade')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(1, (object) ['grade' => 'NEM LÉTEZIK'])->grade;
                }),
            ...
            ExportColumn::make('competitor2.email')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(1, (object) ['email' => 'NEM LÉTEZIK'])->email ??
                        'NINCS MEGADVA';
                }),
            ...
            ExportColumn::make('competitor3.name')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(2, (object) ['name' => 'NEM LÉTEZIK'])->name;
                }),
            ...
            ExportColumn::make('competitor3.grade')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(2, (object) ['grade' => 'NEM LÉTEZIK'])->grade;
                }),
            ...
            ExportColumn::make('competitor3.email')
                ...
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ...
                        ->sortBy('id')
                        ->values()
                        ->get(2, (object) ['email' => 'NEM LÉTEZIK'])->email ??
                        'NINCS MEGADVA';
                }),
            ...
            ExportColumn::make('teacher_names')
                ->label('Tanárok nevei (CSV)')
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ->where('type', CompetitorProfileType::Teacher)
                        ->sortBy('id')
                        ->values()
                        ->pluck('name')
                        ->join(', ');
            ...
            ExportColumn::make('teacher_emails')
                ->label('Tanárok e-mail címjei (CSV)')
                ->state(function (Team $record) {
                    return $record->competitorProfiles
                        ->where('type', CompetitorProfileType::Teacher)
                        ->sortBy('id')
    ...
    {
        $body =
            'A csapatok exportálsa befejeződött: ' .
            number_format($export->successful_rows) .
            ' ' .
            ' sor sikeresen exportálva.';
