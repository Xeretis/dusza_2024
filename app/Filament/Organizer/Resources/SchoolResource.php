        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ...
                    ->required()
                    ->maxLength(255),
                Forms\Components\Fieldset::make('Cím')->schema([
                ...
                Forms\Components\Fieldset::make('A kapcsolattartó adatai')->schema([
        ...
        return $infolist->schema([
            Split::make([
                Grid::make(1)->schema([
                    ...
                    Section::make('A kapcsolattartó adatai')->schema([
                        ...
                        Action::make('sendEmail')
                            ...
                            ->url(function (School $record) {
                                return 'mailto:' . $record->contact_email;
                            })
                    ]),
                ]),
                Section::make([
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('address')
                    ...
                    ->state(function (School $record) {
                        return $record->zip . ' ' . $record->city . ' (' . $record->state . '), ' . $record->street;
                    }),
